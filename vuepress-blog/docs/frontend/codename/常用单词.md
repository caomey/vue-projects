...
boxing 装箱、装箱转换ce (curlyce) 大括号、花括号cket (squarekcet) 中括号、方括号akpoint 断点wser - applications 浏览器应用(程序)wser-accessible application 可经由浏览器访问的应用程序
...
CORBA 通用对象请求中介架构(Common Object Requestker Architecture)
